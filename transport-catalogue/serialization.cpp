...
namespace data_serialization {
    ...
    json::Document Serializer::FromFileDeserializer() {
        if (json_doc_.GetRoot().AsDict().count("serialization_settings"s) > 0) {
            ...
            // %%%%% %%%%% Getting stop and bus data %%%%% %%%%%
            StopAndBusDataSet(proto_catalogue);

            // %%%%% %%%%% Getting Render Settings %%%%% %%%%%
            RenderSettingsSet(proto_catalogue);

            // %%%%% %%%%% Getting Routing Settings %%%%% %%%%%
            RoutingSettingsSet(proto_catalogue);
    ...
    void Serializer::StopAndBusDataSet(const catalog_proto::TransportCatalogue& proto_catalogue) {
    ...
    void Serializer::RenderSettingsSet(const catalog_proto::TransportCatalogue& proto_catalogue) {
    ...
    void Serializer::RoutingSettingsSet(const catalog_proto::TransportCatalogue &proto_catalogue) {
